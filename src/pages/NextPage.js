						...
						<div className="row">
							<div className="col-12 d-flex flex-row flex-wrap p-0" id="mpDiv4">
								<div className="col-12 col-sm-12 col-md-6 p-2 mt-2 mb-2">
									...
									<div className="text-wrap div_description">
										{text.overview}
									</div>
								</div>
								<div className="col-12 col-sm-12 col-md-6 p-2 mt-2 mb-2">
									<div className="flex-item mb-3">
	  									...
	  									<span className="div_description">
	  										{truncate(((cast && cast.map(i => i.original_name).join(', ')) || '') + ((text.guest_stars && text.guest_stars.map(i => i.original_name).join(', ')) || ''), 150)}
	  									</span>
									</div>
									<div className="flex-item mb-3">
										<span style={{ color: 'grey' }}>Genres:</span> {genre && genre.map(i => (<span key={i.id} className="div_description">{i.name}, </span>))}
									</div>
									<div className="flex-item mb-3">
										<span style={{ color: 'grey' }}>This film is:</span> <span className="div_description">Chilling, Ominous</span>
