            ...
            <div className="col-12 col-sm-12 mb-2" style={{ overflowY: 'hidden !important' }}>
              {popupData && (
                <div className="preview" style={{ position: 'fixed', left: previewPosition.left, top: previewPosition.top }}>
                  ...
                  <p className="ps-2 pe-2 div_description" style={{ wordSpacing: '0.5px' }}>{truncate(popupData.overview, 100)}</p>
                ...
                <div className="preview2">
                  ...
                  >
                    <div className="banner__contents">
                      <h1 className="banner__title" style={{ wordSpacing: '5px' }}>
                      ...
                      <h1 className="banner__description div_description" style={{ wordSpacing: '1px', fontSize: '15px' }}>
                      ...
                      <div className="row">
                        <div className="col-12 d-flex flex-row flex-wrap p-0" id="mpDiv4">
                          <div className="col-12 col-sm-12 col-md-6 ps-3 pt-2 pb-2 mt-2 mb-2">
                            ...
                            <div className="flex-item mb-2" style={{ fontSize: '20px', fontWeight: '500', wordSpacing: '5px' }}>No.2 in Films Today</div>
                            <div className="text-wrap div_description" style={{ fontSize: '16px', letterSpacing: '0.1px' }}>
                          ...
                          <div className="col-12 col-sm-12 col-md-6 p-2 mt-2 mb-2">
                            ...
                            <div className="flex-item mb-3">
                              <span style={{ color: 'grey', fontWeight: '500' }}>Genres:</span> {genre && genre.map(i => (<span key={i.id} className="div_description" style={{ fontSize: '17px', letterSpacing: '0.3px' }}>{i.name}, </span>))}
                            </div>
                            <div className="flex-item mb-3">
                              <span style={{ color: 'grey', fontWeight: '500' }}>This film is:</span> <span className="div_description" style={{ fontSize: '17px', letterSpacing: '0.3px' }}>Chilling, Ominous</span>
                            </div>
                          </div>
                              ...
                              episodeData.map((episode, index) => (
                                <div key={index} className="nav__div6" onClick={() => handleEpisode(episode, 'tv')}>
                                        ...
                                        <div className="col-9 ps-2 d-flex flex-column justify-content-between border-0 p-2">
                                          ...
                                          <div className="div_description" style={{ fontSize: '16px', letterSpacing: '0.1px' }}>
                                      ...
                                      <div className="d-flex justify-content-between align-items-center mt-1 smText1">
                                        <div>
                                          ...
                                          <div className="smText2">
                                            <span className="div_description" style={{ fontSize: '16px', letterSpacing: '0.1px' }}>{smovie?.overview && truncate(smovie.overview, 100)}</span>
